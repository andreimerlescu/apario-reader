...
var (
	...
	flag_i_cache_control_database_seconds               = config.NewInt("cache-control-database-seconds", 1209600, "sseconds for http header Cache-Control max-age=1209600 [default 14 days]")
